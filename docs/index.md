...
#### [OpenAI Agents SDK](../OpenAI_Agents_SDK_Guides/)
...
- [Haystack](../Haystack_Guide/) - Production search systems

### Type-Safe Development
- [PydanticAI](../PydanticAI_Guide/) - Structured validation
- [Semantic Kernel](../Semantic_Kernel_Guide/) - Microsoft patterns

### Cloud & Hosted Models
- [Amazon Bedrock Agents](../Amazon_Bedrock_Agents_Guide/) - AWS integration
- [Microsoft Agent Framework](../Microsoft_Agent_Framework_Guide/) - Azure integration
- [Google ADK](../Google_ADK_Guide/) - Google integration
- [Mistral Agents API](../Mistral_Agents_API_Guide/) - Mistral platform
