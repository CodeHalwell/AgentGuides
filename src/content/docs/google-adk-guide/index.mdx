...
<CardGrid>
  <LinkCard
    ...
    description="v2.9.2 · the reference implementation — full feature set, richest ecosystem."
  />
  <LinkCard
    title="🐹 Go"
  ...
  <LinkCard
    ...
    description="v1.0.0 · active development — same architecture, Node + browser."
  />
</CardGrid>
...
|------|---------|---------|
| 2026-09-21 | Py 2.9.2 / Go 1.0.0 / TS 1.0.0 | **Python 2.9.2 update.** Installed google-adk 2.9.2 and source-verified 10 classes from the `optimization` module (newly deepened in this volume) and other underrepresented areas. Added _Class Deep Dives Vol. 4_ covering `SimplePromptOptimizer`, `GEPARootAgentOptimizer`, `Sampler`, `LocalEvalSampler`, `TelemetryConfig`, `UrlContextTool`, `Skill`, `SkillRegistry`, `SkillToolset`, and `VertexAiRagMemoryService`. Updated "latest release" banners in agents, runner-and-sessions, tools, workflows, callbacks-and-plugins, mcp-and-a2a, memory-and-artifacts, evaluation, google_adk_iam_examples, google_adk_advanced_python, and google_adk_comprehensive_guide from 2.9.0/2.8.0 → 2.9.2, worded as "as of 2026-09-21" so they stay accurate after later releases. Python card updated to v2.9.2. |
