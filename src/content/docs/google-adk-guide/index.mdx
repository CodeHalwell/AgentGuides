...
|------|---------|---------|
| 2026-09-21 | Py 2.9.2 / Go 1.0.0 / TS 1.0.0 | **Python 2.9.2 update.** Installed google-adk 2.9.2 and source-verified 10 classes from the new `optimization` module and other underrepresented areas. Added _Class Deep Dives Vol. 4_ covering `SimplePromptOptimizer`, `GEPARootAgentOptimizer`, `Sampler`, `LocalEvalSampler`, `TelemetryConfig`, `UrlContextTool`, `Skill`, `SkillRegistry`, `SkillToolset`, and `VertexAiRagMemoryService`. Updated "latest release" banners in agents, runner-and-sessions, tools, workflows, and callbacks-and-plugins guides from 2.9.0 → 2.9.2. Python card updated to v2.9.2. |
