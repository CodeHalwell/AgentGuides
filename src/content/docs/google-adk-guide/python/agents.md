...
Verified against google-adk==2.3.0 (`google/adk/agents/`). The latest release is **2.9.2**. Most examples require 2.3.0 or later; `LangGraphAgent` requires 2.5.0+; `ManagedAgent` requires 2.4.0+. Per-section minimums are noted where they differ.
