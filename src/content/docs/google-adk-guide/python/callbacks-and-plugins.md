...
Verified against google-adk==2.3.0 (`google/adk/agents/llm_agent.py`, `google/adk/plugins/`). The latest release is **2.9.2** — all examples are compatible with 2.3.0 and later unless noted.
