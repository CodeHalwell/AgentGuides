...
Verified against google-adk==2.4.0 (`google/adk/workflow/`). As of 2026-09-21 the latest release was **2.9.2** — all examples are compatible with 2.4.0 and later unless noted.
