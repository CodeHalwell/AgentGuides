...
Verified against google-adk==2.3.0 (`google/adk/runners.py`, `google/adk/apps/app.py`, `google/adk/sessions/`). The latest release is **2.9.0** — all examples are compatible with 2.3.0 and later unless noted.
