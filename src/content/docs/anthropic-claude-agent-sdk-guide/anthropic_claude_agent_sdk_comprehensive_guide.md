...
Latest: 0.1.76 | Updated: May 7, 2026
...
|---------|------|----------|
| 0.1.76 | May 7, 2026 | Patch releases (0.1.74–0.1.76); stability and dependency updates. Version confirmed against installed `claude-agent-sdk 0.1.76` (`.routine-envs/check-0507`); `query`, `ClaudeSDKClient`, `ClaudeAgentOptions`, `PermissionMode`, `McpServerConfig`, `TextBlock`, `AssistantMessage`, `UserMessage`, `ResultMessage`, `StreamEvent`, `RateLimitEvent` imports verified with `-W error::DeprecationWarning` — all PASS. |
