...
description: "OpenTelemetry traces, metrics, and logs emitted by agent-framework-core 1.2.1. Enable instrumentation, ship to Azure Monitor / OTLP / console, or the VS Code AI Toolkit."
...
Verified against `agent-framework-core==1.2.1` (`agent_framework.observability`).
