...
async def run_interactive(workflow_path: str, inputs: dict) -> None:
    ...
    while True:
        result = await workflow.run(message, responses=responses)
