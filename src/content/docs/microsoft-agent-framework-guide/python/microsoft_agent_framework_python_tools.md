...
description: "The @tool decorator, FunctionTool class, approval gates, explicit schemas, runtime context, invocation limits, and result parsers. All verified against agent-framework-core 1.2.1."
...
Verified against `agent-framework-core==1.2.1` (`agent_framework._tools`).
