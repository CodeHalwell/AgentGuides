...
This follows the [Agent Skills specification](https://agentskills.io). Verified against `agent-framework-core==1.2.1` (`agent_framework._skills`). Marked `experimental` — API may evolve.
