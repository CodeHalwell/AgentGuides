...
This page was verified against `agent-framework-core==1.4.0` and provider packages at `1.0.0b260514` (May 2026). Each sub-package is imported lazily from the `agent_framework.<provider>` namespace — you install the provider package and import from `agent_framework.<provider>`.
