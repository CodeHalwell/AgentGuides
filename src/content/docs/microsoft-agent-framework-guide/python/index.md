---
title: "Microsoft Agent Framework - Python Guide Collection"
description: "Release Date: April 3, 2026 (GA); patch 1.0.1 on April 10, 2026 Framework Status: ✅ GA — Production-Ready with Long-Term Support Platform: Python 3.10+ Latest Version: 1.0.1"
...
👉 **[Complete Python 2025 Features Guide](./microsoft_agent_framework_python_2025_features/)**
...
### **1. [microsoft_agent_framework_python_comprehensive_guide.md](./microsoft_agent_framework_python_comprehensive_guide/)**
...
### **2. [microsoft_agent_framework_python_diagrams.md](./microsoft_agent_framework_python_diagrams/)**
...
### **3. [microsoft_agent_framework_python_production_guide.md](./microsoft_agent_framework_python_production_guide/)**
...
### **4. [microsoft_agent_framework_python_recipes.md](./microsoft_agent_framework_python_recipes/)**
...
Choose your path above and dive in! Start with the [Comprehensive Guide](./microsoft_agent_framework_python_comprehensive_guide/) if this is your first time.
