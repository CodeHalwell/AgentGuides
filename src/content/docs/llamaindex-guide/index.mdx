...
<CardGrid>
  <LinkCard
    ...
    description="v0.14.20 · 100+ data connectors, ReAct agents, llama-agents package."
  />
  <LinkCard
    title="📘 TypeScript"
    href="/llamaindex-guide/typescript/"
    description="@llamaindex/workflow 1.1.24 · event-driven workflows for Node and browser."
  />
</CardGrid>
