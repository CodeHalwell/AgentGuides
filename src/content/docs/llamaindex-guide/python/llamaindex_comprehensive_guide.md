...
Latest: 0.14.22 | Updated: May 18, 2026
...
|---------|------|---------|
| 0.14.22 | May 18, 2026 | Version bumped 0.14.21 → 0.14.22; `Latest:` header and date updated. Patch release; maintenance and dependency updates. Core symbols verified against installed `llama-index-core==0.14.22` (`.routine-envs/check-0518-py`). | Claude routine |
