...
Latest: ag2 0.13.3 | Updated: June 7, 2026
...
|---------|------|---------|
| 0.13.2 | May 29, 2026 | Patch release; stability and dependency updates. `Latest:` header and `**Version:**` updated 0.13.1 → 0.13.2. Core symbols (`ConversableAgent`, `AssistantAgent`, `UserProxyAgent`, `GroupChat`, `GroupChatManager`, `register_function`, `runtime_logging`) verified against installed `ag2==0.13.2` (`.routine-envs/check-0529-ag2`) with warnings suppressed (upstream issue); 57 top-level exports confirmed. | Claude routine |
| 0.13.1 | May 23, 2026 | Patch release; stability and dependency updates. `Latest:` header and `**Version:**` updated 0.13.0 → 0.13.1. Core symbols (`ConversableAgent`, `AssistantAgent`, `UserProxyAgent`, `GroupChat`, `GroupChatManager`, `register_function`, `runtime_logging`) verified against installed `ag2==0.13.1` (`.routine-envs/check-0523-ag2`) with warnings suppressed (upstream issue); 57 top-level exports confirmed. | Claude routine |
