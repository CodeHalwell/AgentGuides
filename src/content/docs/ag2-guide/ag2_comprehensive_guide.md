...
Latest: 0.12.3 | Updated: May 7, 2026
...
|---------|------|---------|
| 0.12.3 | May 7, 2026 | Patch release; stability improvements. Version confirmed against installed `ag2 0.12.3` (`.routine-envs/check-0507`); `autogen.ConversableAgent` import verified with `-W error::DeprecationWarning`. Note: `jsonschema.RefResolver` deprecation warning emitted at import time by `autogen/oai/gemini.py` — internal to ag2, not triggered by guide code. |
