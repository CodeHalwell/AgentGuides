...
Latest: 0.12.3 | Updated: May 8, 2026
...
|---------|------|---------|
| 0.12.3 | May 8, 2026 | Patch release; stability improvements. Version confirmed against installed `ag2 0.12.3` (`.routine-envs/check-0508-ag2`); `autogen.ConversableAgent`, `AssistantAgent`, `UserProxyAgent`, `GroupChat`, `GroupChatManager` imports verified with standard warnings. |
