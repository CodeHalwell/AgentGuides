...
Latest: 2.4.5 | Updated: May 8, 2026
...
|---------|------|---------|
| 2.4.5 | May 8, 2026 | Patch release. Version confirmed against installed `mistralai 2.4.5` (`.routine-envs/check-0508-mistral`); `from mistralai.client import Mistral` import verified with `-W error::DeprecationWarning`. |
