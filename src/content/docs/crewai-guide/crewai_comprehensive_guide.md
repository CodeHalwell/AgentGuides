...
Latest: 1.14.3 | Updated: April 26, 2026
...
|---------|------|---------|
| 1.14.3 | April 26, 2026 | Patch release; stability improvements. Version confirmed against PyPI `crewai 1.14.3`. Imports verified: `from crewai import Agent, Task, Crew` — PASS with `-W error::DeprecationWarning`. |
