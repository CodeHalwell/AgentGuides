...
Latest: 0.3.146 | Updated: May 21, 2026
...
|---------|------|----------|----------|
| 0.3.146 | May 21, 2026 | Patch release; stability and dependency updates. `Latest:` header updated 0.3.145 → 0.3.146. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.146` (`.routine-envs/check-0521-node`); `query`, `tool`, `createSdkMcpServer`, session helpers, error types, transport, and all constants confirmed present. | Claude routine |
