...
Latest: 0.3.143 | Updated: May 18, 2026
...
|---------|------|----------|
| 0.3.143 | May 18, 2026 | Minor series bump 0.2.x → 0.3.x; `Latest:` header and date updated. `unstable_v2_createSession`, `unstable_v2_prompt`, `unstable_v2_resumeSession` removed from public API. All 25 remaining exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.143` (`.routine-envs/check-0518-node`). | Claude routine |
