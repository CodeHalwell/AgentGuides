...
Latest: 0.2.132 | Updated: May 7, 2026
...
|---------|------|----------|
| 0.2.132 | May 7, 2026 | Patch releases (0.2.129–0.2.132); dependency updates and stability improvements. Version confirmed against npm `@anthropic-ai/claude-agent-sdk 0.2.132` (latest, 2026-05-07, `.routine-envs/check-0507-node`). `query` runtime export PASS; `PermissionMode`, `McpServerConfig` type exports confirmed present. |
