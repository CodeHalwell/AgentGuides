...
Latest: 0.3.160 | Updated: June 2, 2026
...
|---------|------|----------|----------|
| 0.3.160 | June 2, 2026 | Patch releases 0.3.159–0.3.160; no API changes. `Latest:` header updated 0.3.158 → 0.3.160; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.160` (`/tmp/npm-0602`); `query`, `tool`, `createSdkMcpServer`, session helpers all PASS. Export count: 25 — PASS. | Claude routine |
| 0.3.158 | May 30, 2026 | Patch releases 0.3.157–0.3.158; no API changes. `Latest:` header updated 0.3.156 → 0.3.158; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.158` (`/tmp/npm-check-0530`); `query`, `tool`, `createSdkMcpServer`, session helpers all PASS. Export count: 25 — PASS. | Claude routine |
| 0.3.156 | May 29, 2026 | Patch releases 0.3.154–0.3.156; no API changes. `Latest:` header updated 0.3.153 → 0.3.156; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.156` (`/tmp/npm-check-0529`); `query`, `tool`, `createSdkMcpServer`, session helpers all PASS. Export count: 25 — PASS. | Claude routine |
| 0.3.153 | May 28, 2026 | Patch release 0.3.153; no API changes. `Latest:` header updated 0.3.152 → 0.3.153; revision history entry added. npm `@anthropic-ai/claude-agent-sdk@0.3.153` confirmed latest (2026-05-28); export surface unchanged at 25 symbols. | Claude routine |
| 0.3.152 | May 27, 2026 | Patch releases 0.3.151–0.3.152; no API changes. `Latest:` header updated 0.3.150 → 0.3.152; revision history entry added. npm `@anthropic-ai/claude-agent-sdk@0.3.152` confirmed latest; export surface unchanged at 25 symbols. | Claude routine |
| 0.3.150 | May 23, 2026 | Patch releases 0.3.149–0.3.150; no API changes. `Latest:` header updated 0.3.148 → 0.3.150; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.150` (`.routine-envs/check-0523-node`); `query`, `tool`, `createSdkMcpServer`, session helpers all PASS. Export count: 25 — PASS. | Claude routine |
| 0.3.148 | May 22, 2026 | Patch releases 0.3.146–0.3.148; no API changes. `Latest:` header updated 0.3.145 → 0.3.148; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.148` (`.routine-envs/check-0522-node`); `query`, `tool`, `createSdkMcpServer`, session helpers all PASS. Export count: 25 — PASS. | Claude routine |
...
| 0.2.126 | May 1, 2026 | Patch releases (0.2.124–0.2.126); dependency updates; version confirmed against npm `@anthropic-ai/claude-agent-sdk 0.2.126` (latest, 2026-05-01). Note: 0.2.125 was not published; sequence goes 0.2.124 → 0.2.126. |
| 0.2.123 | April 29, 2026 | Patch releases (0.2.122–0.2.123); dependency updates; version confirmed against npm `@anthropic-ai/claude-agent-sdk 0.2.123`. |
