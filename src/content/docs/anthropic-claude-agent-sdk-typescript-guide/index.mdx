...
## What's new in v0.3.168 (June 2026)

- **v0.3.168 (June 2026)** — Patch releases 0.3.166–0.3.168; no API changes; same 25-export surface as 0.3.165. `@anthropic-ai/claude-agent-sdk@0.3.168` confirmed latest stable via npm registry (2026-06-08); `query`, `tool`, `createSdkMcpServer`, session helpers, and all constants unchanged. Export count: 25 — PASS.
- **v0.3.167 (June 2026)** — Patch release; stability and dependency updates.
- **v0.3.166 (June 2026)** — Patch release; stability and dependency updates.
