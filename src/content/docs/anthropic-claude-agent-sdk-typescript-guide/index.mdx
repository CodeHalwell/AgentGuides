...
## What's new in v0.3.146 (May 2026)

- **v0.3.146 (May 2026)** — Patch release. No API changes; same 25-export surface as 0.3.145. All exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.146` (`.routine-envs/check-0521-node`); `query`, `tool`, `createSdkMcpServer`, session helpers, error types, transport, and all constants confirmed present.
...
|------|-------------------------------|--------------------|----------|
| 2026-05-21 | @anthropic-ai/claude-agent-sdk 0.3.146 | Version bumped 0.3.145 → 0.3.146; "What's new" heading updated to v0.3.146; v0.3.146 bullet added; revision history entry added. All 25 exports verified against installed `@anthropic-ai/claude-agent-sdk@0.3.146` (`.routine-envs/check-0521-node`); `query`, `tool`, `createSdkMcpServer`, session helpers, error types, transport, and all constants confirmed present. | Claude routine |
