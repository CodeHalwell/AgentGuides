...
| `trace_policy` | `TracePolicy \| None` | Control how this node's run is traced in LangSmith (omit inputs, outputs, or both). See [TracePolicy reference](./reference-trace-policy/). |
