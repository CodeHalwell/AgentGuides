---
title: "LangGraph.js Comprehensive TypeScript Guide"
description: "> Package: @langchain/langgraph > Version: 1.2.9 (April 19, 2026) — previously 1.0.2 (November 2025)"
framework: langgraph
language: typescript
---
...
### 1. **[langchain_langgraph_comprehensive_guide.md](./langchain_langgraph_comprehensive_guide/)** (Core Reference)
...
### 2. **[langchain_langgraph_diagrams.md](./langchain_langgraph_diagrams/)** (Visual Architecture Reference)
...
### 3. **[langchain_langgraph_production_guide.md](./langchain_langgraph_production_guide/)** (Deployment and Operations)
...
|------|---------|---------|
| 2026-04-20 | 1.2.9 | Version pin updated to 1.2.9 (April 19, 2026); frameworks.ts metadata corrected to match guide header | Claude routine |
