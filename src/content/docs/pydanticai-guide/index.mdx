...
- **v1.104.0 (May 2026)** — Minor release. Maintenance and dependency updates. All core guide symbols verified with `-W error::DeprecationWarning` against installed `pydantic-ai==1.104.0` (`.routine-envs/check-0529-pydantic`); all PASS. 178 top-level exports confirmed; API surface unchanged from 1.103.0.
...
|------|-------------------------------|--------------------|----------|
| 2026-05-29 | pydantic-ai 1.104.0 | Version bumped 1.102.0 → 1.104.0 (two minor releases: 1.103.0, 1.104.0); "What's new" heading updated to v1.104.0; v1.103.0 and v1.104.0 bullets added. All core guide symbols verified with `-W error::DeprecationWarning` against installed `pydantic-ai==1.104.0` (`.routine-envs/check-0529-pydantic`); all PASS. 178 top-level exports confirmed; API surface unchanged. | Claude routine |
