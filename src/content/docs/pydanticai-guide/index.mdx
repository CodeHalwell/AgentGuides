...
- **v1.99.0 (May 2026)** — Minor release. Maintenance and dependency updates. All core guide symbols verified against installed `pydantic-ai==1.99.0` (`.routine-envs/check-0520-pydantic`); no `DeprecationWarning` emissions on any non-`ag_ui` imports.
...
|------|-------------------------------|--------------------|----------|
| 2026-05-20 | pydantic-ai 1.99.0 | Version bumped 1.98.0 → 1.99.0; "What's new" heading updated to v1.99.0; v1.99.0 bullet added; revision history entry added. All core guide symbols verified against installed `pydantic-ai==1.99.0` (`.routine-envs/check-0520-pydantic`) with `-W error::DeprecationWarning`; all PASS. | Claude routine |
