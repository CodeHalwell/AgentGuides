...
<CardGrid>
  ...
  <LinkCard title="19 · Class deep dives" href="./pydantic_ai_class_deep_dives/" description="AgentRun.iter, AgentRunResult, ConcurrencyLimiter, Direct API, capture_run_messages, format_as_xml, common_tools · 25 min" />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard title="Class deep dives" href="./pydantic_ai_class_deep_dives/" description="AgentRun, AgentRunResult, ConcurrencyLimiter, Direct API, capture_run_messages, format_as_xml, common_tools, ExternalToolset, FilteredToolset, FunctionToolset+instructions" />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard title="Class deep dives" href="./pydantic_ai_class_deep_dives/" description="AgentRun, ConcurrencyLimiter, Direct API, capture_run_messages, format_as_xml, common_tools, ExternalToolset." />
  <LinkCard title="Advanced patterns" href="./pydantic_ai_advanced_patterns/" />
...
## What's new in v1.100.0 (May 2026)

- **v1.100.0 (May 2026)** — Version milestone release (1.99.x → 1.100.x); maintenance and dependency updates. New dependency: `griffelib>=2.0` (2.0.2 installed). All core guide symbols (`Agent`, `RunContext`, `ModelRetry`, `AgentRunResult`, `StreamedRunResult`, `capture_run_messages`, `UsageLimits`, `RunUsage`, `limit_model_concurrency`, `AGUIAdapter`) verified against installed `pydantic-ai==1.100.0` (`.routine-envs/check-0521-pydantic`) with `-W error::DeprecationWarning`; all PASS.
...
|------|-------------------------------|--------------------|----------|
| 2026-05-21 | pydantic-ai 1.100.0 | Version bumped 1.99.0 → 1.100.0 (milestone); "What's new" heading updated to v1.100.0; v1.100.0 bullet added; revision history entry added. New dependency: `griffelib>=2.0`. All core guide symbols verified against installed `pydantic-ai==1.100.0` (`.routine-envs/check-0521-pydantic`) with `-W error::DeprecationWarning`; all PASS. | Claude routine |
