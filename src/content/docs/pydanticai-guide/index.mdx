...
<CardGrid>
  ...
  <Card title="Version" icon="information">
    **v2.40.0** · September 2026 · Python 3.10+
    _Each page carries its own "verified against" stamp: the newest deep dives are on 2.40.0, the class reference on 2.33.0, and some older topic pages still sit on the 1.10x line._
  </Card>
