...
<CardGrid>
  ...
  <Card title="Version" icon="information">
    **v2.40.0** · September 2026 · Python 3.10+
    _Latest deep-dive page verified at 2.40.0; earlier pages at 2.36.0 / 2.33.0._
  </Card>
...
|------|-------------------|---------|
| 2026-09-07 | pydantic-ai 2.40.0 | Added `pydantic_ai_class_deep_dives_v2_40.md` — 10 source-verified deep dives for 2.40.0 (`RealtimeSession`, `RealtimeModelSettings`/`TurnDetection`, `AgentRealtime`, `Capability`, `Hooks`, `TemplateStr`, `ExternalToolset`, `RetryConfig`/`HTTPX2TenacityTransport`, `DuckDuckGoSearchTool`, `ImageGenerationSubagentTool`). Sources read: `realtime/_session.py`, `realtime/settings.py`, `agent/abstract.py`, `capabilities/capability.py`, `capabilities/hooks.py`, `template.py`, `toolsets/external.py`, `retries.py`, `common_tools/duckduckgo.py`, `common_tools/image_generation.py`. Version bumped from 2.36.0 → 2.40.0. |
