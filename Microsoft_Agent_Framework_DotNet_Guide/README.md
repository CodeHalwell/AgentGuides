...
2. Read: `microsoft_agent_framework_dotnet_comprehensive_guide.md` → Core Fundamentals + Simple Agents sections
3. View: `microsoft_agent_framework_dotnet_diagrams.md` → System Architecture section
4. Code: `microsoft_agent_framework_dotnet_recipes.md` → Beginner Recipes
...
2. Read: `microsoft_agent_framework_dotnet_comprehensive_guide.md` → Multi-Agent + Tools sections
3. Code: `microsoft_agent_framework_dotnet_recipes.md` → Intermediate Recipes
4. Build: Multi-agent workflow following Recipe 4
5. View: `microsoft_agent_framework_dotnet_diagrams.md` → Multi-Agent Orchestration

**Estimated Time:** 6-8 hours

### **Path 3: Advanced (Production)**
1. Prerequisites: Complete Intermediate path
2. Read: `microsoft_agent_framework_dotnet_production_guide.md` → All sections
3. View: `microsoft_agent_framework_dotnet_diagrams.md` → Deployment Architecture
4. Code: `microsoft_agent_framework_dotnet_recipes.md` → Advanced Recipes + Integration
...
3. Check `microsoft_agent_framework_dotnet_recipes.md` for code examples
4. Reference `microsoft_agent_framework_dotnet_diagrams.md` for architecture
